...
// if (process.env.NOW_URL || process.env.PINAMU_HEROKU_URL) {
//     const http = require('http');
//     const port = process.env.PORT || 8080;

//     http.createServer(bot.middleware()).listen(port, () => bot.setWebhook(process.env.NOW_URL || process.env.PINAMU_HEROKU_URL));
// } else {
